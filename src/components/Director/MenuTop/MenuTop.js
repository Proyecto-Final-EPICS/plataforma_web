...
export default function MenuTop(props){
    ...
    return(
        <div className="director-menu-top">
            <Button type="link" onClick={() => setMenuCollapsed(!menuCollapsed)} >
                <img
                    className="director-menu-top__left-logo"
                    src={logo}
                    alt="logo joystick"
                />
            </Button>
            <div className="director-menu-top__right">
                <UserOutlined />
                <Dropdown overlay={menu}>
                    <a target="_blank" className="ant-dropdown-link" onClick={e => e.preventDefault()}>
                        <span className="director-menu-top__right__user">{"user"}</span>  <DownOutlined />
                    </a>
               </Dropdown>
            </div>
